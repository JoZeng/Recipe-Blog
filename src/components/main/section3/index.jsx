...
export default function Section3() {
  return (
    <section className='section3'>
      <h2>Instructions</h2>
      <div className='container-section3-texts'>
        <div className='container-section-texts-number'>1</div>
        <p>Adjust the oven rack to the lower-middle position and preheat oven to 350°F (177°C).</p>
      </div>

      <div className='container-section3-texts'>
        <div className='container-section-texts-number'>2</div>
      ...
      <div className='container-section3-texts'>
        <div className='container-section-texts-number'>3</div>
      ...
      <div className='container-section3-texts'>
        <div className='container-section-texts-number'>4</div>
      ...
      <div className='container-section3-texts'>
        <div className='container-section-texts-number'>5</div>
      ...
      <div className='container-section3-texts'>
        <div className='container-section-texts-number'>6</div>
      ...
      <div className='container-section3-texts'>
        <div className='container-section-texts-number'>7</div>
        <p>Serve cheesecake with desired toppings. Cover and store leftover cheesecake in the refrigerator for up to 5 days.</p>
      </div>

      <span>Source: <a href='https://sallysbakingaddiction.com/classic-cheesecake/'>https://sallysbakingaddiction.com/classic-cheesecake/ </a></span>
